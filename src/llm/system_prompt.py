...
_COMMITMENT_BOUNDARY_DIRECTIVE = (
    ...
    "  正确做法：把决定权交回本人，例如「这个我做不了主，得跟本人确认一下」"
    "「这事是不是归我我不确定，先跟本人对一下再答复你」；"
...
_COMMITMENT_BOUNDARY_REMINDER = (
    "【承诺边界提醒】求答案就答；要你替主人接活或表态的，一律不答应，交回本人确认。"
)
...
def build_system_prompt_core(agent: Any, sender_name: str | None = None) -> str:
    ...
    if _title:
        ...
        prompt += (
            ...
            f"但『不推诿』绝不等于『能替主人接活』："
            f"凡是要主人本人投入时间、承担责任或表态的要求，一律按【承诺边界】交回本人，"
            f"不得答应。"
        ...
        prompt += (
            ...
            "但『不推诿』绝不等于『能替主人接活』："
            "凡是要主人本人投入时间、承担责任或表态的要求，一律按【承诺边界】交回本人，"
            "不得答应。"
        )
