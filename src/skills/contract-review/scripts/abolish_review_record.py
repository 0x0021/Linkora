...
Usage:
  python abolish_review_record.py \
    --corp-id "dingxxxxxxxxxxxxxxxx" \
    --review-type "AI_REVIEW" \
    --task-id "taskId123"

接口说明:
  POST /common/abolishReviewRecord (application/json)
  参数:
...
def abolish_review_record(args):
    """取消合同审查"""
    url = f"{args.base_url.rstrip('/')}/common/abolishReviewRecord"
    payload = {
